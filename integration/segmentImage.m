function out = segmentImage(im, net, patchSize) % for 2 channel image represented as 3 cahannel RGB
% Modificated by A.Husch 12.2018
...
im_pad = padarray (im, padSize, 'symmetric', 'post');
...
for i = 1:patchSize(1):height_pad
    ...
    for j =1:patchSize(2):width_pad
        ...
        im_pad(i:i+patchSize(1)-1,j:j+patchSize(2)-1,:);
